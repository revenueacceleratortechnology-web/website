...
export type ContentPage = { title: string; intro: string[]; sections: ContentSection[]; faqs: { q: string; a: string }[]; source?: string };
...
const services: [string, string, string][] = [
 ...
 ['coaching','Amazon coaching','Work through a specific marketplace question with an experienced specialist. Bring the account context, recent changes, and the decision you need to make so the session stays practical.'],
];
...
for(const [path,title,body] of [
 ...
 ['events','Events and learning','Speak with RA Tech about upcoming learning opportunities and focused Amazon coaching. For help with an immediate account question, explore a coaching session.'],
 ...
 ['coaching','Amazon coaching','Bring a specific Amazon challenge to a focused discussion. We help you clarify the question, assess the account context, and identify practical next steps.'],
 ['digital-products','Amazon workflows and learning','Explore structured operating procedures and coaching to support your internal Amazon team. Discuss the process or capability you want to develop with RA Tech.'],
] ) add(path,title,body,'business');
const aliases: Record<string,string> = {
 'Amazon PPC':'/services/ppc-management','Amazon Design & Creative':'/services/design','Design & creative':'/services/design','Design & listing':'/services/design','Troubleshooting & recovery':'/services/troubleshooting','Specialist capabilities':'/services/amazon-dsp','Platform management':'/services/troubleshooting','Account management':'/services/full-service-management','Free account audit':'/services/account-audit','DTC services':'/dtc','Category Expertise':'/categories','Digital Products':'/digital-products','Results':'/results','Case studies':'/results','Testimonials':'/testimonials','Client testimonials':'/testimonials','About RA Tech':'/about','About Us':'/about','Our specialists':'/about','Our journey':'/about','Leadership':'/about','Contact':'/contact','Contact us':'/contact','All services':'/services','Services':'/services','Resources':'/resources','News':'/resources','Articles':'/resources','Webinar library':'/resources','FAQs':'/#faq','Careers':'/careers','Events':'/events','Partnerships':'/partnerships','Press':'/press','Coaching':'/coaching','Grow your supplement brand':'/categories/supplements','Sell more beauty on marketplaces':'/categories/beauty-products','Build growth beyond marketplaces':'/dtc','Turn emails into revenue':'/dtc/email-marketing',
};
